...
void Class_Realization::Init(Texture t1, Texture t2)
{
		t1.loadFromFile("./images/background.jpg");
	   t2.loadFromFile("./images/gems.jpg");
}

void Class_Realization::swap(piece p1, piece p2)
{
...
void Class_Realization::Realization(RenderWindow & app)
{
...
//======================================================================================================================
	...
	int time_end = time_start +  Class_Option::time_static;///////////////////////////////////sdsvgdnrfgh
	...
	while (app.isOpen())
	{
		...
		//==================================ЕСЛИ НАБРАНО ОПРЕДЕЛЕННОЕ КОЛИЧЕСТВО БАЛОВ
		{
			if (calc2 > Class_Option::points_static)
			{
				sound.stop();
				winer = true;
				app.close();
				RenderWindow widow(sf::VideoMode(740, 479), "Game Over");
				Class_Game_over obj;
				obj.Wind(widow, raz, winer);
			}
